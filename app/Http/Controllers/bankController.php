...
class bankController extends Controller
{
    ...
    public function listReportBank(Request $request){
    	...
    	return view('dashboard.dashboard-reportpendanaanbank')->with('reportBank',$result)->with('campaigns', Auth::user()->bank->pluck('nama_proyek', 'id_pendanaan_bank'))->with('years', range(ReportBank::first()->tahun, date('Y')));
    }
